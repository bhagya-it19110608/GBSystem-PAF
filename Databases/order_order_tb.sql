...
CREATE TABLE `order_tb` (
  ...
  `orderCategory` varchar(45) DEFAULT NULL,
  `paymentMethod` varchar(45) DEFAULT NULL,
  `orderPayment` double DEFAULT NULL,
  PRIMARY KEY (`orderID`)
...
INSERT INTO `order_tb` VALUES (1,'che','pay','cc',120.15);
...
-- Dump completed on 2021-04-25 18:44:14
